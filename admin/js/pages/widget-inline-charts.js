...
$(function () {
	...
	$("#sparkline5").sparkline([18, 22, 38, 20], {
        type: 'pie',
        height: '100',
        sliceColors: ['#3aa0dc', '#06d79c', '#745af2', '#2962FF'],
  ...
  function drawDocSparklines() {
    ...
    $('#compositebar').sparkline([7,3,10,5,4,8,6,4,2,4,5,3,4,5],
        {composite: true, fillColor: false, lineColor: '#2962FF'});
    ...
    $('#linecustom').sparkline('html',
        {
          height: '1.5em', width: '8em', lineColor: '#2962FF', fillColor: '#ffbc34',
    ...
    $('#compositeline').sparkline([7,3,10,5,4,8,6,4,2,4,5,3,4,5],
        {composite: true, fillColor: false, lineColor: '#2962FF', changeRangeMin: 0, chartRangeMax: 10});
    ...
    $('#discrete2').sparkline('html',
        {type: 'discrete', lineColor: '#3aa0dc', thresholdColor: '#2962FF', thresholdValue: 4});
